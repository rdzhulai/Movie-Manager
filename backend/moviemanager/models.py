...
class Actor(Base):
    ...
    movies = relationship(
        "Movie", secondary=movie_actors, back_populates="actors", order_by="Movie.name"
    )
...
class Movie(Base):
    ...
    actors = relationship(
        "Actor", secondary=movie_actors, back_populates="movies", order_by="Actor.name"
    )
    ...
    series = relationship("Series", back_populates="movies", uselist=False)
...
class Studios(Base):
    ...
    movies = relationship("Movie", back_populates="studios", order_by="Movie.name")
